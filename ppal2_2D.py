...
SIMPLES DIFERENCIAS (PSEUDODISTANCIAS) CON LA NETWORK
@author: mjjimene
"""
...
# vector b
    ...
    for i in range(len(data_BS_coor)):
        ro_BS_Base=math.sqrt((data_BS_coor[i][0]-x_UTM_cal_Net_Base)**2+(data_BS_coor[i][1]-y_UTM_cal_Net_Base)**2)
        ro_BS_Rover=math.sqrt((data_BS_coor[i][0]-x_UTM_cal_Net_R)**2+(data_BS_coor[i][1]-y_UTM_cal_Net_R)**2)
        ...
        for p in range(len(data_geo_coord_network_Base)):
             ...
             R_BS_Base=math.sqrt((data_BS_coor[i][0]-x_UTM_B)**2+(data_BS_coor[i][1]-y_UTM_B)**2)
             ...
             R_BS_Rover=math.sqrt((data_BS_coor[i][0]-x_UTM_R)**2+(data_BS_coor[i][1]-y_UTM_R)**2)
