...
DOBLES DIFERENCIAS CON LA NETWORK
@author: mjjimene
"""
...
while it<1:
    ...
    for i in range(len(data_BS_coor)):
        ...
        for p in range(len(data_geo_coord_network_Base)):
             ...
             R_BS1_Base=math.sqrt((data_BS_coor[i][0]-x_UTM_B)**2+(data_BS_coor[i][1]-y_UTM_B)**2+(data_BS_coor[i][2]-data_geo_coord_network_Base[p][2])**2)
             R_BS2_Base=math.sqrt((data_BS_coor[q][0]-x_UTM_B)**2+(data_BS_coor[q][1]-y_UTM_B)**2+(data_BS_coor[q][2]-data_geo_coord_network_Base[p][2])**2)
             ...
             R_BS1_Rover=math.sqrt((data_BS_coor[i][0]-x_UTM_R)**2+(data_BS_coor[i][1]-y_UTM_R)**2+(data_BS_coor[i][2]-data_geo_coord_network_Rover[p][2])**2)
             R_BS2_Rover=math.sqrt((data_BS_coor[q][0]-x_UTM_R)**2+(data_BS_coor[q][1]-y_UTM_R)**2+(data_BS_coor[q][2]-data_geo_coord_network_Rover[p][2])**2)
